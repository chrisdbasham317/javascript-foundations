...
describe('Medusa', function() {
  ...
  it('should unstone the the first victim and stone the 4th coming in', function() {
    var medusa = new Medusa('Karissa');
    var victim1 = new Person('Chris');
    var victim2 = new Person('Dan');
    var victim3 = new Person('Felly');
    var victim4 = new Person('Dennis');
console.log(victim1, victim2, victim3, victim4)
    medusa.stare(victim1);
